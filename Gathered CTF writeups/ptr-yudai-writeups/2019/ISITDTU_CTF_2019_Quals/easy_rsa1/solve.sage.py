...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_p18 = RealNumber('.18'); _sage_const_60 = Integer(60); _sage_const_4 = Integer(4); _sage_const_ = Integer(); _sage_const_ = Integer(); _sage_const_0p292 = RealNumber('0.292')
import time
...
def example():
    ...
    # the modulus
    N = _sage_const_ 
    # the public exponent
    e = _sage_const_ 
