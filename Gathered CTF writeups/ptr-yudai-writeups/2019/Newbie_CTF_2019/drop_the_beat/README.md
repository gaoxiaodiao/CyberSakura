# [pwn 845pts] dRop the beat - Newbie CTF 2019
64ビットで全部無効です。
```
$ checksec -f drop_the_beat_easy
RELRO           STACK CANARY      NX            PIE             RPATH      RUNPATH      Symbols         FORTIFY Fortified       Fortifiable  FILE
Partial RELRO   No canary found   NX enabled    No PIE          No RPATH   No RUNPATH   75 Symbols     No       0               2       drop_the_beat_easy
```
単純なBOFがあります。libcも配られているのでやるだけ。
```python
from ptrlib import *
